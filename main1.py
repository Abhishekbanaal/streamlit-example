...
if search_button:
    ...
    #             feature={
    #                 "mark": {"is_show": True},
    #                 "dataView": {"is_show": True, "readonly": False},
    #                 "restore": {"is_show": True},
    #                 "saveAsImage": {"is_show": True},
    #             },
    #         ),
    #         title_opts=opts.TitleOpts(title="Nightingale Chart"),
    #     )
    # )
    #
    ...
    #
    # # Use Streamlit's components.html function to display the chart
    # st.components.v1.html(html, width=700, height=600)

# create radar chart using pyecharts
# radar = (
#     Radar()
#     .add_schema(
#         schema=[
#             opts.RadarIndicatorItem(name="Score1", max_=full_df['Score1'].max()),
#             opts.RadarIndicatorItem(name="Score2", max_=full_df['Score2'].max()),
#             opts.RadarIndicatorItem(name="Score3", max_=full_df['Score3'].max()),
#             opts.RadarIndicatorItem(name="Score4", max_=full_df['Score4'].max()),
#             opts.RadarIndicatorItem(name="Score5", max_=full_df['Score5'].max()),
#         ]
#     )
#     .add(
#         series_name="Feature Ranking",
#         data=filtered_df.loc[:, ["Score1", "Score2", "Score3", "Score4", "Score5"]].values.tolist(),
#         areastyle_opts=opts.AreaStyleOpts(opacity=0.5),
#         linestyle_opts=opts.LineStyleOpts(width=1),
#     )
#     .set_series_opts(label_opts=opts.LabelOpts(is_show=True))
#     .set_global_opts(title_opts=opts.TitleOpts(title="Feature Ranking"))
# )
